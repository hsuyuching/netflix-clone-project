...
$plan->setName('Metflix monthly subscription')
  ->setDescription('Get you all the feature of our site.')
  ->setType('INFINITE');
...
// $_SERVER[REQUEST_URI] -> http://.../xxx.php/dfkjs, return xxx.php/dfkjs
